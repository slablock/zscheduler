...
import com.github.slablock.zcheduler.core.common.config.Log4jShutdown;
import com.github.slablock.zcheduler.core.guice.ManageLifecycleInit;
import com.github.slablock.zcheduler.core.lifecycle.LifecycleStart;
import com.github.slablock.zcheduler.core.lifecycle.LifecycleStop;
...
public class Log4jShutterDownerModule implements Module {
    ...
    private static final Logger log = LoggerFactory.getLogger(Log4jShutterDownerModule.class);
    ...
    public void configure(Binder binder) {
        ...
        try {
            ...
            if (!(contextFactory instanceof Log4jContextFactory)) {
                log.warn(
                        "Expected [{}] found [{}]. Unknown class for context factory. Not logging shutdown",
            ...
            if (!(registry instanceof Log4jShutdown)) {
                log.warn(
                        "Shutdown callback registry expected class [{}] found [{}]. Skipping shutdown registry",
            ...
            log.warn("Not registering log4j shutdown hooks. Not using log4j?", e);
        }
    }
